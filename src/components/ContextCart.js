                        ...
                        <div className="col-md-3 order-1 mb-5 mb-md-0">
                            <div className="border p-4 rounded mb-4">
                                ...
                                <ul className="list-unstyled mb-0">
                                    ...
                                    <li className="mb-1">
                                        <NavLink to=""  value="men" onClick={(e)=>setCategory('6481778f84241f241e000daa')} className="d-flex">
                                            <span>Men</span>{" "}
                                    ...
                                    <li className="mb-1">
                                        <NavLink to="" value="women" onClick={(e)=>setCategory('648177b984241f241e000e59')} className="d-flex">
                                            <span>Women</span>{" "}
                                    ...
                                    <li className="mb-1">
                                        <NavLink to="" value="children" onClick={(e)=>setCategory('648177c584241f241e000e5b')} className="d-flex">
                                            <span>Children</span>{" "}
